...
export async function GET(request: Request) {
  try {
    ...
    const selectFields = isFactoryUser
      ...
      : `id, customer_name, customer_email, customer_phone, recipient_name, recipient_phone, recipient_same_as_orderer, order_category, parent_order_id, inquiry_id, delivery_fee, created_at, paid_at, total_amount, order_status, payment_status, payment_method, shipping_method, country_code, postal_code, state, city, address_line_1, address_line_2, tracking_number, tracking_carrier, logen_registered_at, logen_slip_printed, shipping_box_qty, refund_reason, customer_note, attachment_urls, notes, original_amount, custom_unit_price, admin_discount, admin_surcharge, coupon_discount, applied_coupon_id, pricing_note, payment_link_token, customer_editable_fields, share_token, partner_mall_id, partner_mall:partner_malls(id,name,slug), salesman_id, attributed_salesman:salesman_profiles!salesman_id(id,display_name,salesman_code), order_items(id, purchase_order_status, design_title${itemMedia}, assigned_manufacturer_id, factory_assigned_at, factory_status, factory_amount, deadline, factory_payment_date, factory_payment_status)`;
    ...
    if (isAdminLike(profile.role) && factoryId) {
      ...
      query = adminClient.from('orders').select(
        `id, customer_name, customer_email, customer_phone, recipient_name, recipient_phone, recipient_same_as_orderer, order_category, delivery_fee, created_at, paid_at, total_amount, order_status, payment_status, payment_method, shipping_method, country_code, postal_code, state, city, address_line_1, address_line_2, refund_reason, customer_note, attachment_urls, notes, original_amount, custom_unit_price, admin_discount, admin_surcharge, coupon_discount, applied_coupon_id, pricing_note, payment_link_token, customer_editable_fields, share_token, partner_mall_id, partner_mall:partner_malls(id,name,slug), salesman_id, attributed_salesman:salesman_profiles!salesman_id(id,display_name,salesman_code), order_items!inner(id, purchase_order_status, design_title, assigned_manufacturer_id, factory_assigned_at, factory_status, factory_amount, deadline, factory_payment_date, factory_payment_status)` as string
