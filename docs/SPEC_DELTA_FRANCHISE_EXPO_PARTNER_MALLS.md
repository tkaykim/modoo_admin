...
- 로고 전처리는 외곽 배경뿐 아니라 로고 내부에 갇힌 동일 배경색 영역도 투명하게 제거하며, 투명 배경 PNG의 실제 로고 색상은 보존한다.
- `scripts/franchise-expo/repair-logos.ts`는 운영 Storage의 원본·대비 로고 3종을 새 전처리 결과와 비교하고, `--commit` 시 동일 경로의 에셋과 DB 연결 URL을 갱신하는 운영 보정 도구다.
